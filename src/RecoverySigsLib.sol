...
library RecoverySigsLib {
    ...
    function hash(ISignatureTransfer.SignatureTransferDetails calldata details) internal pure returns (bytes32) {
    ...
    function hash(RecoverySigs calldata data) internal pure returns (bytes32) {
